...
audit.auditPrint ("Number of ballots is: " +
...
audit.
	  auditPrint
	  ("Following is the ballot data ( 0 means no pref indicated at that position");
...
GenerateBallots (output, k);
	    
k = k + 1;
	  
}
	
audit.auditPrint ("Generated " + std::to_string (numBallots) +
			   " ballots");
...
audit.auditPrint ("We have a tie between " +
					       allcandstie);
			
			  //audit.auditPrint("They all have "++" votes.")
